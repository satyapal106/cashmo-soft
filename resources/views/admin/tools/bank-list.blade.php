        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ url('admin/import-banks') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label">Upload Excel <span class="text-danger">*</span></label>
                                <input type="file" class="form-control" name="file" required>
                            </div>
                            <button type="submit" class="btn btn-success w-100">Import Banks List</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchAgentTypes() {
                $.get("{{ url('admin/get-bank-list') }}", function(data) {
                    let html = '';
                    if (data.length > 0) {
                        ...
                        <tr id="agentTypeRow-${type.id}">
                            ...
                            <td>
                                <button class="btn btn-warning btn-sm editAgentType" data-id="${type.id}" data-name="${type.BankName}">Edit</button>
