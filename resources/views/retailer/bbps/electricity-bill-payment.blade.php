                    ...
                    <div class="card-body">
                        <form id="dthForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-6 mb-3">
                                    <label for="">Electricity Board</label>
                                    <input type="text" class="form-control" name="electricity_board" placeholder="Electricity Board" required>
                                </div>
                                <div class="col-lg-12 col-md-6 mb-3">
                               ...
                               <div class="col-lg-12 col-md-6 mb-3">
                                    <input type="text" class="form-control" name="Consumer Number" placeholder="Consumer Number" required>
                                </div>
                            </div>
                            <div class="mt-2">
