                        ...
                        <form id="dthForm">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="Insurer" placeholder="Insurer" required>
                                </div>
                                <div class="col-lg-12 col-md-6 mb-3">
                                    <label for="">Policy Number</label>
                                    <input type="text" class="form-control" name="policy_number" placeholder="Policy Number" required>
                                </div>
                                <div class="col-lg-12 col-md-6 mb-3">
                                    <label for="">Email Id (Optional)</label>
                                    <input type="text" class="form-control" name="State" placeholder="Email Id" required>
                                </div>
                                <div class="col-lg-12 col-md-6 mb-3">
