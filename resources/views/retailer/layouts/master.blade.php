...
<head>
    ...
    <meta charset="utf-8" />
    <title>Dashboard | Cashmo - Retailer & Dashboard</title>
                ...
                <div class="navbar-header">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        use App\Models\Wallet;
                           $wallet = Wallet::where('user_id', Auth::guard('retailer')->user()->id)->first(); 
                        @endphp
                        @if($wallet)
                            <p class="fw-bold mt-3" style="font-size:15px;">
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                                ...
                                <span class="d-flex align-items-center">
                                    @if (Auth::guard('retailer')->check() && Auth::guard('retailer')->user()->profile_image)
                                        <img class="rounded-circle header-profile-user"
                                            src="{{ asset(Auth::guard('retailer')->user()->profile_image) }}"
                                            alt="Header Avatar">
                                    @else
                                        <img class="rounded-circle header-profile-user"
                                    ...
                                    <span class="text-start ms-xl-2">
                                        <span
                                            class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{ Auth::guard('retailer')->user()->name }}</span>
                                    </span>
                                </span>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" href="{{url('retailer/profile')}}"><i
                                        class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span
                                        class="align-middle">Profile</span></a>
                                <a class="dropdown-item" href="{{ url('retailer/user-wallet') }}">
                                    <i class="mdi mdi-wallet text-muted fs-16 align-middle me-1"></i>
                                    <span class="align-middle">Wallet</span>
                                </a>
                                        
                                <a class="dropdown-item" href="{{ url('retailer/logout') }}"><i
