                        ...
                        <form id="dthForm">
                           ...
                           <div class="row">
                            ...
                            <div class="col-lg-12 col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" name="adhaarnumber" placeholder="XXXXXXXX1234" required>
                            </div>
                            <div class="col-lg-12 col-md-6 mb-3">
                                <label for="">Mobile Number</label>
                                <input type="number" class="form-control" name="mobilenumber" placeholder="9900000099" required>
                            </div>
                            <div class="col-lg-12 col-md-6 mb-3">
                            ...
                            <div class="col-lg-12 col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="referenceno" placeholder="Unique txn value" required>
                            </div>
                            <div class="col-lg-12 col-md-6 mb-3">
                                <label for="">Sub Merchant ID</label>
                                <input type="text" class="form-control" name="submerchantid" placeholder="Merchant code" required>
                            </div>
                             <div class="col-lg-12 col-md-6 mb-3">
                            ...
                            <div class="col-lg-12 col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="ipaddress" placeholder="9.9.9.9" required>
                            </div>
                        </div>
